...
class hyper(object):
    ...
    warm_up = False
    # shapes
    node_type_num = 43  # original = 40, total number of node types
    ...
    def initialize(clz, from_cmd=True, **kwargs):
        if from_cmd:
            ...
            parser.add_argument('--embedding_dir',
                                ...
                                default='../tmp/workspace/tflogs/model')
            ...
            parser.add_argument('--weight_decay', help='weight decay factor', type=float, default=0.001)
            ...
            parser.add_argument('--output_dim',
                                help='output, default to 1. Should not need to change', type=float, default=1)
            parser.add_argument('--node_type_num', help='total number of node types', type=int, default=43)
